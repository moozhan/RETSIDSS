...
function TempLocation() {
    ...
    const _onCreate = e => {
        ...
        if(layerType === "polygon"){
            ...
            const popupContent = '<p>Area: ' +smallarea + 'M<sup>2</sup></p> '+ '<p>Produced Energy: '+ energyproduced +' KWh</p>';
        ...
        <LayersControl position="topright">
            ...
            <FeatureGroup>
                <EditControl 
                    ...
                    draw={{rectangle: false, polyline:false, circle: false, circlemarker: false, marker: true}}/>
                <EditControl 
